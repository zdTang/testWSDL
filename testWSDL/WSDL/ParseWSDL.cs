...
namespace testWSDL.WSDL
{
    public class ParseWSDL
    {

        /// <summary>
        /// parameter:    A service URI
        /// return value: A object which composes the content of a Web service
        /// </summary>
        /// <param name="Uri"></param>
            private static void ParseOne(string Uri)
            {
            //Build the URL request string
            //UriBuilder uriBuilder = new UriBuilder(@"http://www.dneonline.com/calculator.asmx");
            UriBuilder uriBuilder = new UriBuilder(Uri);
            uriBuilder.Query = "WSDL";//?WSDL
